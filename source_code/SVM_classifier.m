...
for i = 1:150
    ...
    clearvars -except feature_mat feat label acc svm_acc_p svm_std_p fda_acc_p fda_std_p SVM_ACC SVM_STD FDA_ACC FDA_STD perc p emb1 emb2 tau1 tau2 fda_acc svm_acc FDA_acc_all SVM_acc_all
end
